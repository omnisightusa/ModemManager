...
G_DEFINE_TYPE (MMSimQuectel, mm_sim_quectel, MM_TYPE_BASE_SIM)
...
static void
parent_load_sim_identifier_ready (MMSimQuectel   *self,
                                  GAsyncResult *res,
                                  GTask        *task)
{
    GError *error = NULL;
    ...
    simid = MM_BASE_SIM_CLASS (mm_sim_quectel_parent_class)->load_sim_identifier_finish (MM_BASE_SIM (self), res, &error);
    if (simid)
...
error:
    ...
    MM_BASE_SIM_CLASS (mm_sim_quectel_parent_class)->load_sim_identifier (self,
...
MMBaseSim *
mm_sim_quectel_new_finish (GAsyncResult  *res,
                         GError       **error)
{
    GObject *source;
    GObject *sim;
...
void
mm_sim_quectel_new (MMBaseModem          *modem,
                  GCancellable         *cancellable,
                  GAsyncReadyCallback   callback,
                  gpointer              user_data)
{
    g_async_initable_new_async (MM_TYPE_SIM_QUECTEL,
                                G_PRIORITY_DEFAULT,
                                cancellable,
                                callback,
                                user_data,
...
static void
mm_sim_quectel_init (MMSimQuectel *self)
{
}

static void
mm_sim_quectel_class_init (MMSimQuectelClass *klass)
{
